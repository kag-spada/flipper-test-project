    ...
    <>
      <Box sx={{
        ...
        <Box sx={{
          ...
          <Box sx={{
            background: 'linear-gradient(to right, transparent 0%, rgba(28,41,50,0.1)) 50%, transparent 100%)'
          }}>
            <Box
              component="img"
              sx={{
        ...
        <Box sx={{
          ...
          <Box sx={{
            ...
            <Typography sx={{
              ...
              lineHeight: "normal",
              textTransform: "uppercase",
            }}>Previous rolls</Typography>
            <Box sx={{
              background: 'linear-gradient(to right, transparent, rgba(28,41,50,0.1))',
            }}>
              <Box
                component="img"
                sx={{
          ...
          <Box sx={{
            ...
            <Box sx={{
              ...
              />
              <InputBase
                sx={{ ml: 1, flex: 1, color: "#454E61", minWidth: "100px", width: "120px", fontSize: "12px" }}
                placeholder="Enter Bet Amount"
                inputProps={{ 'aria-label': "Enter Bet Amount", "color": "#454E61", }}
              />
              <Divider sx={{ height: "23px", m: 0.5, borderRightWidth: "1px", background: "#5B6C79", }} orientation="vertical" />
            </Box>
            <Box sx={{
              ml: 2,
              pt: 0.5,
      ...
      <Box sx={{
        ...
        <Box sx={{ display: "flex", justifyContent: "space-between", mb: 2 }}>
          <Typography sx={{
            ...
            lineHeight: "35px",
            color: "white"
          }}>Daily Roulette Race</Typography>
          <Typography sx={{
            fontSize: "12px",
            color: "#AAB5C6"
          }}>Ends in 5h 23 min 11 sec</Typography>
        </Box>
        <DailyRouleteTable />
      </Box>
    </>
