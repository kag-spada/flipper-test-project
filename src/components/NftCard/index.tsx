...
const NftCard = () => {
  return (
    <Card sx={{  height: "325px", borderRadius: "30px", backgroundColor: "#16222A" }}>
      <CardActionArea>
        <CardMedia
          sx={{
        ...
        <Box sx={{
          ...
          background: "linear-gradient(to bottom, rgba(40,45,50, 0.4), rgba(40,45,50, 0.73))",
          p: 1
        }}>
          <Typography sx={{
            fontSize: "12px",
        ...
        <CardContent sx={{ p:0, textAlign: 'center' }}>
          ...
          <Button sx={{
            ...
            bgcolor: "16222A",
            textTransform: "none"
          }} variant="outlined">Watch Coin Flip</Button>
        </CardContent>
      </CardActionArea>
    </Card>
  );
